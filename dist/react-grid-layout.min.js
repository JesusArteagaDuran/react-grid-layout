!(function(t, e) {
  ...
  return (function(t) {
    ...
    function(t, e, n) {
      ...
      function u(t, e) {
        return (0, k.default)(
          M.default.Children.map(t, function(t) {
            return t.key;
          }),
          M.default.Children.map(e, function(t) {
            return t.key;
          })
        );
      }
      ...
      function c(t, e, n) {
        for (
          var r = m(t), o = _(t, e), a = Array(t.length), i = 0, u = o.length;
          i < u;
          i++
        ) {
          var l = s(o[i]);
          l.static || ((l = p(r, l, e, n, o)), r.push(l)),
            (a[t.indexOf(o[i])] = l),
            (l.moved = !1);
        }
        return a;
      ...
      function p(t, e, n, r, o) {
        var i = "vertical" === n,
          s = "horizontal" === n;
        if (i) for (e.y = Math.min(a(t), e.y); e.y > 0 && !y(t, e); ) e.y--;
        else if (s)
          for (e.y = Math.min(a(t), e.y); e.x > 0 && !y(t, e); ) e.x--;
        for (var u = void 0; (u = y(t, e)); )
          s ? f(o, e, u.x + u.w, "x") : f(o, e, u.y + u.h, "y"),
            s && e.x + e.w > r && ((e.x = r - e.w), e.y++);
        return e;
      }
      function d(t, e) {
        for (var n = m(t), r = 0, o = t.length; r < o; r++) {
          var a = t[r];
          if (
        ...
        if (r) {
          ...
          if (!y(t, u))
            return (
              ...
              v(t, n, i ? u.x : void 0, s ? u.y : void 0, r, !1, o, a)
            );
        }
        return v(t, n, i ? n.x + 1 : void 0, s ? n.y + 1 : void 0, r, !1, o, a);
      }
      function w(t) {
        return 100 * t + "%";
      }
      ...
      function D(t, e, n, r) {
        ...
        var o = [];
        return (
          M.default.Children.forEach(e, function(e, n) {
            var r = h(t, String(e.key));
            if (r) o[n] = s(r);
            else {
              !N &&
                e.props._grid &&
              ...
              var i = e.props["data-grid"] || e.props._grid;
              i
                ? (N || j([i], "ReactGridLayout.children"),
                  (o[n] = s(z({}, i, { i: e.key }))))
                : (o[n] = s({ w: 1, h: 1, x: 0, y: a(o), i: String(e.key) }));
            }
          }),
          (o = d(o, { cols: n })),
          (o = c(o, r, n))
      ...
      (e.emptyFunction = o),
        ...
        (e.synchronizeLayoutWithChildren = D),
        (e.validateLayout = j),
        (e.autoBindHandlers = E);
      var C = n(3),
        k = r(C),
        P = n(0),
        M = r(P),
    ...
    function(t, e, n) {
      (function(t, n) {
        ...
        function q(t) {
          return !(!pt(t) || rt(t)) && (ct(t) ? le : Ft).test(it(t));
        }
        function Y(t) {
        ...
        (qt["[object Float32Array]"] = qt["[object Float64Array]"] = qt[
          ...
          (qt[St] = qt[_t] = qt[It] = qt[Rt] = qt[Bt] = qt[Dt] = qt[jt] = qt[
            Et
          ] = qt[zt] = qt[Ct] = qt[Pt] = qt[Nt] = qt[Lt] = qt[At] = qt[
            "[object WeakMap]"
          ] = !1);
        var Yt = "object" == typeof t && t && t.Object === Object && t,
          Xt =
            "object" == typeof self && self && self.Object === Object && self,
          Vt = Yt || Xt || Function("return this")(),
        ...
        (f.prototype.clear = p),
          ...
          (_.prototype.has = j),
          (_.prototype.set = E),
          (T.prototype.add = T.prototype.push = z),
          (T.prototype.has = C),
          (k.prototype.clear = P),
        ...
        var ke = ge
            ...
            : yt,
          Pe = B;
        ((be && Pe(new be(new ArrayBuffer(1))) != Bt) ||
          (we && Pe(new we()) != zt) ||
          (xe && "[object Promise]" != Pe(xe.resolve())) ||
          (Se && Pe(new Se()) != Lt) ||
          (_e && "[object WeakMap]" != Pe(new _e()))) &&
          (Pe = function(t) {
            var e = B(t),
    ...
    function(t, e, n) {
        ...
        w = (function(t) {
          ...
          return (
            ...
            (e.prototype.componentWillReceiveProps = function(t) {
              if (t.isResizable || t.isDraggable) {
                var e = void 0;
                if (
              ...
              if (t && t.key) {
                ...
                return l.default.createElement(
                  v.default,
                  {
                    ...
                    cancel: d,
                    handle: h,
                    onDragStop: m ? this.onDragStop : g.emptyFunction,
                    onDragStart: m ? this.onDragStart : g.emptyFunction,
                    onDrag: m ? this.onDrag : g.emptyFunction,
                    onResizeStart: b ? this.onResizeStart : g.emptyFunction,
                    onResize: b ? this.onResize : g.emptyFunction,
                    onResizeStop: b ? this.onResizeStop : g.emptyFunction,
                    isDraggable: m,
                    isResizable: b,
      ...
      (w.displayName = "ReactGridLayout"),
        (w.propTypes = {
          ...
          layout: function(t) {
            if ((b || (b = t.layout), t.isResizable || t.isDraggable)) {
              var e = t.layout;
              if (((b = t.layout), !e)) return;
              (0, g.validateLayout)(e, "layout");
            }
            return b;
          },
          ...
          return (
            ...
            (e.prototype.mixinDraggable = function(t, e) {
              return l.default.createElement(
                ...
                {
                  onStart: e
                    ? this.onDragHandler("onDragStart")
                    : h.emptyFunction,
                  onDrag: e ? this.onDragHandler("onDrag") : h.emptyFunction,
                  onStop: e
                    ? this.onDragHandler("onDragStop")
                    : h.emptyFunction,
            ...
            (e.prototype.mixinResizable = function(t, e, n) {
              var r = this.props,
                ...
                u = r.maxW,
                c = r.maxH,
                f = this.calcPosition(0, 0, o - a, 0).width,
                p = this.calcPosition(0, 0, i, s),
                y = this.calcPosition(0, 0, u, c),
                g = [p.width, p.height],
                m = [Math.min(y.width, f), Math.min(y.height, 1 / 0)];
              return l.default.createElement(
                d.Resizable,
                {
                  className: n ? "resizable" : "no-resizable",
                  width: e.width,
                  height: e.height,
                  minConstraints: g,
                  maxConstraints: m,
